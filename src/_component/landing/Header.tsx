            ...
            <div className="w-full px-6 py-3">
                <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="hidden md:flex items-center gap-5 text-sm text-white">
                        <a onClick={() => router.push("/register")} className="hover:text-[#C9A24D] transition-colors cursor-pointer">
                            Crea tu cuenta
                        </a>
                        <a onClick={() => router.push("/register")} className="font-semibold hover:text-[#C9A24D] transition-colors cursor-pointer">
                            Ingresá
                        </a>
                        <Link href="#" className="hover:text-[#C9A24D] transition-colors cursor-pointer">
                            Mis compras
                        </Link>
