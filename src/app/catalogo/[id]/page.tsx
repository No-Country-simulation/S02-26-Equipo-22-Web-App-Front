...
import { ChevronLeft, Ruler, Weight, Tag, MapPin, CheckCircle2 } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <main className="container mx-auto px-4 py-8">
                {/* Breadcrumb section */}
                <div className="mb-6">
                    <Link href="/catalogo" className="inline-flex items-center text-[#000000] underline hover:text-[#B38F43] transition-colors font-medium text-sm">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                        ...
                        <div className="p-8 md:p-10 flex flex-col">
                            <div className="mb-6">
                                <h1 className="text-3xl font-bold text-[#1F140D] mb-2">{horse.name}</h1>
                                <p className="text-xl text-[#C9A24D] font-bold">{horse.price}</p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                    ...
                                    <div className="font-semibold text-gray-900">{horse.age}</div>
                                </div>
                                <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                    <div className="text-gray-500 text-sm mb-1">Pelaje</div>
                                    <div className="font-semibold text-gray-900">{horse.color}</div>
                                </div>
                                <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                    <div className="flex items-center gap-2 text-gray-500 text-sm mb-1">
                                        <Ruler size={14} /> Alzada
                                    </div>
                                    <div className="font-semibold text-gray-900">{horse.height}</div>
                                </div>
                                <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                    <div className="text-gray-500 text-sm mb-1">Sexo</div>
                                    <div className="font-semibold text-gray-900">{horse.gender}</div>
                                </div>
                            </div>

                            {/* Description */}
                            <div className="mb-8 flex-grow">
                                <h3 className="text-lg font-bold text-[#1F140D] mb-3">Descripción</h3>
                            ...
                            <div className="flex items-center gap-3 bg-green-50 text-green-800 p-4 rounded-xl mb-8 border border-green-100">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs opacity-90 mt-0.5">Sanidad al día y documentación en regla.</p>
                                </div>
                            </div>
