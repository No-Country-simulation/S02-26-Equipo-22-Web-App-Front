...
import { namesFormulariRegister } from "@/mock/mock";
...
export default function Register() {
  ...
  const {
    ...
    loading,
    response
  } = useFormRegister(namesFormulariRegister, useRegisterValidations)
              ...
              <form onSubmit={handleSubmit}>
                <div>
                  ...
                  <div className="mt-2">
                    ...
                    />
                    {errors.dni && (
                      <p className="text-red-400 my-0">{errors.dni}</p>
                    )}
                  </div>
                </div>
                <div>
                  ...
                  <div className="mt-2">
                    ...
                    />
                    {errors.name && (
                      <p className="text-red-400 my-0">{errors.name}</p>
                    )}
                  </div>
                </div>
                <div>
                  ...
                  <div className="mt-2">
                    ...
                    />
                    {errors.lastname && (
                      <p className="text-red-400 my-0">{errors.lastname}</p>
                    )}
                  </div>
                </div>
                <div>
