...
const LocationSection = () => {
  ...
  return (
    <section
      id="contacto"
      ref={sectionRef}
      className="scroll-reveal py-24 bg-[#F9F7F5]"
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg leading-relaxed">
            Nuestras puertas siempre están abiertas para quienes comparten
            nuestra pasión. Ven a conocer al equipo y descubre cómo podemos
            ayudarte.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          ...
          <div className="flex flex-col justify-between">
              ...
              {[
                {
                  ...
                  title: "Dirección",
                  detail:
                    "Av. del Libertador 1234, Ciudad de Buenos Aires, Argentina",
                },
                {
                  icon: Phone,
                  title: "Teléfono",
            ...
            <Link
              href="/contact"
              className="mt-8 inline-flex items-center justify-center gap-2 bg-[#C9A24D] text-white font-semibold py-4 px-8 rounded-xl hover:bg-[#B8913C] transition-all duration-300 hover:shadow-lg hover:shadow-[#C9A24D]/25 group w-full md:w-auto"
